...
# Для KSP - исключаем первую точку
ax3.plot(ksp_data['Высота (м)'][1:] / 1000, ksp_data['Давление (Па)'][1:], 
        'b-', linewidth=2, label='Симуляция KSP', alpha=0.6)
# Для Saturn V - исключаем первую точку
ax3.plot(saturnv_data['Высота (м)'][1:] / 1000, saturnv_data['Давление (Па)'][1:], 
        'r--', linewidth=2, label='Saturn V (расчет)', alpha=0.8)
...
ax6.plot(ksp_data['Время (с)'][1:], ksp_data['Гравитация (Н)'][1:] / 1e6, 
         'b-', linewidth=2, label='Симуляция KSP', alpha=0.8)
ax6.plot(saturnv_data['Время (с)'][1:], saturnv_data['Гравитация (Н)'][1:] / 1e6, 
         'r--', linewidth=2, label='Saturn V (расчет)', alpha=0.8)
...
# Для KSP
ax7.plot(ksp_data['Высота (м)'][1:] / 1000, ksp_data['Плотность (кг/м³)'][1:], 
        'b-', linewidth=2, label='Симуляция KSP', alpha=0.6)
# Для Saturn V
ax7.plot(saturnv_data['Высота (м)'][1:] / 1000, saturnv_data['Плотность (кг/м³)'][1:], 
        'r--', linewidth=2, label='Saturn V (расчет)', alpha=0.8)
...
ax8.plot(ksp_data['Время (с)'][1:], ksp_data['Тяга (Н)'][1:] / 1e6, 
         'b-', linewidth=2, label='Симуляция KSP', alpha=0.8)
ax8.plot(saturnv_data['Время (с)'][1:], saturnv_data['Тяга (Н)'][1:] / 1e6, 
         'r--', linewidth=2, label='Saturn V (расчет)', alpha=0.8)
